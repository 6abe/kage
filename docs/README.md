...
Spec for a tool that is not built yet. If code and these files disagree later, the CLI `--help` and JSON output win.

| File | Read when |
|---|---|
| [../README.md](../README.md) | What Kage is and what it is not |
